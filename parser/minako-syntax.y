...
parameterlist: type id | type id ',' parameterlist_cont;
parameterlist_cont: type id ',' parameterlist_cont | type id;
functioncall: id '(' call_args ')';
call_args: %empty | assignment | assignment ',' call_args_cont;
call_args_cont: assignment ',' call_args_cont | assignment;
...
ifstatement: KW_IF '(' assignment ')' statblock | KW_IF '(' assignment ')' statblock KW_ELSE statblock;
...
printf: KW_PRINTF '(' assignment ')' | KW_PRINTF '(' CONST_STRING ')';
...
;
simpexpr: '-' term simpexpr_cont | term simpexpr_cont;
simpexpr_cont: %empty | '+' term simpexpr_cont | '-' term simpexpr_cont | OR term simpexpr_cont;
term: factor term_cont;
term_cont: %empty | '*' factor term_cont | '/' factor term_cont | AND factor term_cont;
